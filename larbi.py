...
try:
	prox= requests.get('https://github.com/Larbihannachi/Larbi/data/main/proxies.txt').text
...
android_models=[]
try:
	xx = requests.get('https://github.com/Larbihannachi/Larbi/data/main/strings.txt').text.splitlines()
	for line in xx:
...
usr=[]
try:
	jf=requests.get('https://github.com/Larbihannachi/Larbi/data/main/ua.txt').text.splitlines()
	for us in jf:
		usr.append(us)
except: pass
